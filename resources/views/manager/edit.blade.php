<x-app-layout>
    ...
    <a href="{{ route('manager.index') }}" class="m-2 btn btn-rounded btn-success waves-effect waves-light"><i
            class="bx bx-plus font-size-16 me-2  align-middle"></i>all Manager</a>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control select2" id="gender" name="gender" required>
                                            <option value="male" @selected(old('gender', $manager->gender) == 'male')> male
                                            </option>
                                            <option value="female" @selected(old('gender', $manager->gender) == 'female')>Fe male
                                            </option>
                                        </select>
                                        <div class="valid-feedback">
                                            @lang('validation.good')
